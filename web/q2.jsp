...
<form name="form">
    <table>
   <tr>
    <th colspan='13'><h3>Registro de Notas de Estudiantes Quimestre II</h3></th><br><br>
   </tr>
   <tr>
  ...
  <tr>
    <td width="20"><SELECT NAME="materia" required>
  <%
        try{
    ...
    <td><input type="number" size="2" min="1" name="matricula" required></td>
    ...
    <td><input type="NUMBER" size="2" id="iii" min="0" max="10" step="any" name="iii" required onblur="checkDecimals(this, this.value)"></td>
    ...
    <td><input type="NUMBER" size="2" min="0" max="10" id="q2" name="q2" step="any" required onblur="checkDecimals(this, this.value)"></td>
...
<br>
<br>
<input type="submit" value="Ingresar" onclick="document.form.action = 'ServletRegistro1';  document.form.submit()">
