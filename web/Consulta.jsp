...
ResultSet rs = Estamento.executeQuery("select id_materia, materias.nombre, matricula_estudiante, i, ci, ii, cii, iii, ciii, ochenta, examen, veinte, q1, c from quimestre1 inner join materias on materias.id = quimestre1.id_materia where id_materia = "+ materia +" and matricula_estudiante = "+ matricula +"");
while(rs.next()) {
...
<table>
<tr>
<th colspan='13'><h3>Consulta para Modificar Notas Quimestre I</h3></th><br><br>
</tr>
<tr>
...
<tr>
    ...
    <td><input id=q1 type=NUMBER size=2 min=0 max=10 value="<%= q11 %>" name=q1 step=any required onblur="checkDecimals(this, this.value)"></td>
