...
String c = request.getParameter("c");
   ...
   int updateQuery = 0;
           try{
               ...
               String queryString = "Update quimestre2 Set i = "+i+", ci = '"+ci+"', ii = "+ii+", cii = '"+cii+"', iii = "+iii+", ciii = '"+ciii+"', ochenta = "+ochenta+", examen = "+examen+", veinte = "+veinte+", q2 = "+q2+", c = '"+c+"' Where id_materia = "+materia+" and matricula_estudiante = "+matricula+" ";
               System.out.println("Update quimestre2 Set i = "+i+", ci = '"+ci+"', ii = "+ii+", cii = '"+cii+"', iii = "+iii+", ciii = '"+ciii+"', ochenta = "+ochenta+", examen = "+examen+", veinte = "+veinte+", q2 = "+q2+", c = '"+c+"' Where id_materia = "+materia+" and matricula_estudiante = "+matricula+" ");
